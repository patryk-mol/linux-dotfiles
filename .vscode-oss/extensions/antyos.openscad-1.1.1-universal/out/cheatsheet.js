...
class Cheatsheet {
    ...
    getStyleSheet(styleKey) {
        ...
        const styleSrc = styleKey in colorScheme
            ...
            : colorScheme['auto'];
        // Get style sheet URI
        return vscode.Uri.file(path.join(this._extensionPath, 'media', styleSrc)).with({ scheme: 'vscode-resource' });
    ...
    getWebviewContent(styleKey) {
        ...
        const htmlDocument = new jsdom_1.JSDOM(htmlContent).window.document;
